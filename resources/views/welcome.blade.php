                                                                    ...
                                                                    <div data-repeater-item>
                                                                        ...
                                                                        <div class="form-group row mb-5">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                ...
                                                                                <select name="paraghraphe.topic" class="form-select form-select-solid" data-kt-repeater="select2" data-placeholder="موضوع Topic" >
																					<option value=""></option>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <select name="paraghraphe.subtopic" class="form-select form-select-solid" data-kt-repeater="select2" data-placeholder="موضوع فرعي Subtopic" >
                                                                                    <option value=""></option>
